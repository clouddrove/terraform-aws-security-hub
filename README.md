...
<a href="https://github.com/clouddrove/clouddrove/terraform-aws-security-hub/releases/latest">
  <img src="https://img.shields.io/github/release/clouddrove/clouddrove/terraform-aws-security-hub.svg" alt="Latest Release">
</a>
<a href="https://github.com/clouddrove/clouddrove/terraform-aws-security-hub/actions/workflows/tfsec.yml">
  <img src="https://github.com/clouddrove/clouddrove/terraform-aws-security-hub/actions/workflows/tfsec.yml/badge.svg" alt="tfsec">
</a>
<a href="LICENSE.md">
...
**IMPORTANT:** Since the master branch used in source varies based on new modifications, we recommend using the [release versions](https://github.com/clouddrove/terraform-aws-security-hub/releases).
...
## Feedback 
Spot a bug or have thoughts to share with us? Let's squash it together! Log it in our [issue tracker](https://github.com/clouddrove/terraform-aws-security-hub/issues), feel free to drop us an email at [hello@clouddrove.com](mailto:hello@clouddrove.com).
